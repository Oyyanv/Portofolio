...
export const ProjectSection = () => {
    return(
        <section id="Project" className="xl:overflow-x-hidden">
     ...
     {/* Card Component 1*/}
        <div class="relative flex flex-col mt-12 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-52 xl:w-52">
            <div
                class="relative h-18 xl:h-28 mx-4 -mt-6 overflow-hidden text-white shadow-lg bg-clip-border rounded-xl bg-blue-gray-500 shadow-blue-gray-500/40">
                <img
